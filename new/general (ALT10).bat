...
--filter-tcp=2053,2083,2087,2096,8443 --hostlist-domains=discord.media --dpi-desync=fake --dpi-desync-repeats=6 --dpi-desync-fooling=ts --dpi-desync-fake-tls="%TlsHello%" --dpi-desync-fake-tls-mod=none --new ^
...
--filter-tcp=80,443 --hostlist="%HostListGeneral%" %HostListExcludeArg% %IpSetExcludeArg% --dpi-desync=fake --dpi-desync-repeats=6 --dpi-desync-fooling=ts --dpi-desync-fake-tls="%TlsHello%" --dpi-desync-fake-tls-mod=none --new ^
...
--filter-tcp=80,443,%GameFilter% %IpSetArg% %HostListExcludeArg% %IpSetExcludeArg% --dpi-desync=fake --dpi-desync-repeats=6 --dpi-desync-fooling=ts --dpi-desync-fake-tls=^! --dpi-desync-fake-tls-mod=rnd,sni=www.google.com --dpi-desync-fake-tls="%TlsHello%" --dpi-desync-fake-tls-mod=none --new ^
