...
--filter-tcp=2053,2083,2087,2096,8443 --hostlist-domains=discord.media --dpi-desync=multisplit --dpi-desync-split-seqovl=568 --dpi-desync-split-pos=1 --dpi-desync-split-seqovl-pattern="%TlsHello%" --new ^
...
--filter-tcp=80,443 --hostlist="%HostListGeneral%" %HostListExcludeArg% %IpSetExcludeArg% --dpi-desync=multisplit --dpi-desync-split-seqovl=568 --dpi-desync-split-pos=1 --dpi-desync-split-seqovl-pattern="%TlsHello%" --new ^
...
--filter-tcp=80,443,%GameFilter% %IpSetArg% %HostListExcludeArg% %IpSetExcludeArg% --dpi-desync=multisplit --dpi-desync-split-seqovl=568 --dpi-desync-split-pos=1 --dpi-desync-split-seqovl-pattern="%TlsHello%" --new ^
